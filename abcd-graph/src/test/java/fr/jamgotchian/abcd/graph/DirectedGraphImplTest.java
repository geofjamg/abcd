...
public class DirectedGraphImplTest {
    ...
    public void testSelfLoopGraph2() {
        ...
        assertTrue(ImmutableSet.of(v0, v1, v2).equals(graph.getVertices()));
        assertTrue(ImmutableSet.of(e01, e12, e11).equals(graph.getEdges()));
        assertTrue(graph.getPredecessorsOf(v0).isEmpty());
        assertTrue(graph.getIncomingEdgesOf(v0).isEmpty());
        assertTrue(ImmutableSet.of(v1).equals(graph.getSuccessorsOf(v0)));
        assertTrue(ImmutableSet.of(e01).equals(ImmutableSet.copyOf(graph.getOutgoingEdgesOf(v0))));
        assertTrue(ImmutableSet.of(v0, v1).equals(graph.getPredecessorsOf(v1)));
        assertTrue(ImmutableSet.of(e01, e11).equals(ImmutableSet.copyOf(graph.getIncomingEdgesOf(v1))));
        assertTrue(ImmutableSet.of(v1, v2).equals(graph.getSuccessorsOf(v1)));
        assertTrue(ImmutableSet.of(e12, e11).equals(ImmutableSet.copyOf(graph.getOutgoingEdgesOf(v1))));
        assertTrue(graph.getSuccessorCountOf(v1) == 2);
        assertTrue(graph.getPredecessorCountOf(v1) == 2);
        assertTrue(ImmutableSet.of(v1).equals(graph.getPredecessorsOf(v2)));
        assertTrue(ImmutableSet.of(e12).equals(ImmutableSet.copyOf(graph.getIncomingEdgesOf(v2))));
    ...
    public void testParallelEdges() {
        ...
        assertTrue(ImmutableSet.of(v0, v1).equals(graph.getVertices()));
        assertTrue(ImmutableSet.of(e01_1, e01_2).equals(graph.getEdges()));
    }
