...
public interface StatementVisitor<R, A> {
    ...
    R visit(BlockStatement block, A arg);

    R visit(ReturnStatement stmt, A arg);

    R visit(LocalVariableDeclarationStatement stmt, A arg);

    R visit(ExpressionStatement stmt, A arg);

    R visit(CommentStatement stmt, A arg);
    ...
    R visit(WhileStatement stmt, A arg);
